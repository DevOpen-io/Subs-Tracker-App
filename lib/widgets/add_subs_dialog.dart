...
class AddSubsDialog extends StatefulWidget {
  const AddSubsDialog({super.key});

  @override
  State<AddSubsDialog> createState() => _AddSubsDialogState();
}

class _AddSubsDialogState extends State<AddSubsDialog> {
        ...
        FilledButton(
          onPressed: () {
            if (_formKey.currentState!.validate()) {
              ...
              Navigator.pop(
                context,
                SubSlice(_nameCtrl.text.trim(), amount, _selected, _selectedDate),
              );
            }
          },
