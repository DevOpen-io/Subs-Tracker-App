...
mixin _$SettingsSlice {
 ...
 ThemeMode? get theme;@NullableFileConverter() Uint8List? get profilePicture; String? get userName; String? get email;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsSlice&&(identical(other.theme, theme) || other.theme == theme)&&const DeepCollectionEquality().equals(other.profilePicture, profilePicture)&&(identical(other.userName, userName) || other.userName == userName)&&(identical(other.email, email) || other.email == email));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,theme,const DeepCollectionEquality().hash(profilePicture),userName,email);
...
@useResult
$Res call({
 ThemeMode? theme,@NullableFileConverter() Uint8List? profilePicture, String? userName, String? email
});
...
/// Create a copy of SettingsSlice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? theme = freezed,Object? profilePicture = freezed,Object? userName = freezed,Object? email = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode? theme, @NullableFileConverter()  Uint8List? profilePicture,  String? userName,  String? email)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsSlice() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode? theme, @NullableFileConverter()  Uint8List? profilePicture,  String? userName,  String? email)  $default,) {final _that = this;
switch (_that) {
case _SettingsSlice():
return $default(_that.theme,_that.profilePicture,_that.userName,_that.email);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode? theme, @NullableFileConverter()  Uint8List? profilePicture,  String? userName,  String? email)?  $default,) {final _that = this;
switch (_that) {
case _SettingsSlice() when $default != null:
return $default(_that.theme,_that.profilePicture,_that.userName,_that.email);case _:
  return null;
...
class _SettingsSlice implements SettingsSlice {
  const _SettingsSlice({this.theme, @NullableFileConverter() this.profilePicture, this.userName, this.email});
...
/// Create a copy of SettingsSlice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? theme = freezed,Object? profilePicture = freezed,Object? userName = freezed,Object? email = freezed,}) {
